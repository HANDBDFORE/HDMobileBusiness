...
static NSString *APPROVE_PROPERTY_EMPLOYEE_ID = @"employee_id";
...
@property(retain ,nonatomic) NSNumber *instanceParam;//useless
...
@property(copy, nonatomic) NSString *workflowName;//useless
