...
-(Approve *)initWithDictionary:(NSDictionary *)dic{
    if (self = [super init]){
        ...
        self.employeeId = [dic objectForKey:APPROVE_PROPERTY_EMPLOYEE_ID];
        
        self.rowID = [dic objectForKey:@"rowid"];
    }
    return self;
}

//-(NSString *)description{
//    return [NSString stringWithFormat:@"%@ recordId:%i rowid:%i ,screenname:%@",[super description],self.recordID.intValue,self.rowID.intValue,self.docPageUrl];
//}
