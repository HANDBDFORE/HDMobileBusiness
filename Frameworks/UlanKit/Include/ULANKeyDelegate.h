...
#define CFIST_ERROR_PIN_NOT_MODIFY              0x2033C004
...
/**
 *  called when get PIN status
 *
 *  @param err : nil is ok
 *  default PIN has not been changed,you can prompt user or disconnect ulan in this callback.
 */
