  ...
  if (self) {
    ...
    self.navigationItem.rightBarButtonItem =
      ...
      [[NSNotificationCenter defaultCenter] addObserver: self
                                               selector: @selector(deivceOrientationDidChange:)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)deivceOrientationDidChange:(NSNotification*)notification
{
    UIDevice * device =  notification.object;
//    [[UIApplication sharedApplication] setStatusBarOrientation:device.orientation];
    [self willAnimateRotationToInterfaceOrientation:[device orientation]
 duration:0];
}
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation
  ...
  if (fromInterfaceOrientation == UIDeviceOrientationFaceUp||
      fromInterfaceOrientation == UIDeviceOrientationFaceDown) {
      return;
  }
